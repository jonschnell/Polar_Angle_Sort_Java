...
public class PolarAngleComparator implements Comparator<Point> {
	...
	public int compare(Point p1, Point p2) {
		if (p1.equals(p2)) {
			return 0;
				...
				|| ((comparePolarAngle(p1, p2) == 0 && comparePolarAngle(p1, p2) == -1))) {
			return -1;
		} else {
			return 1;
		}
	...
	public int comparePolarAngle(Point p1, Point p2) {
		// pretty sure this function has a bug that causes inconsistent polar sorting
	...
	/*
	 * // a if (p1.equals(p2)) { return 0; //b } else if (!p1.equals(referencePoint)
	 * && !p2.equals(referencePoint) && (crossProduct(p1, p2) == 0 && dotProduct(p1,
	 * p2) > 0) && dotProduct(p1, p2) > 0) { return 0; } else if
	 * (p1.equals(referencePoint)) { return -1; } else if
	 * (!p2.equals(referencePoint)) { // 1 if (p1.getY() < referencePoint.getY() &&
	 * p2.getY() < referencePoint.getY() && crossProduct(p1, p2) < 0) { return -1; }
	 * // 2 else if (p1.getY() == referencePoint.getY()) { // a if (p2.getY() <
	 * referencePoint.getY()) { return -1; // b } else if (p1.getY() ==
	 * referencePoint.getY() && p1.getX() > referencePoint.getX() && p2.getX() <
	 * referencePoint.getX()) { return -1; // c } else if (p2.getY() >
	 * referencePoint.getY() && p1.getX() > referencePoint.getX()) { return -1; } }
	 * // 3 else if (p1.getY() > referencePoint.getY()) { // a if (p2.getY() >
	 * referencePoint.getY() && crossProduct(p1, p2) > 0) { return -1; } // b else
	 * if (p2.getY() == referencePoint.getY() && p1.getX() < referencePoint.getX())
	 * { return -1; } // c else if (p2.getY() < referencePoint.getY()) { return -1;
	 * } }
	 * 
	 * }
	 * 
	...
	private int crossProduct(Point p1, Point p2) {
		// p1 vector
		int p1vx = p1.getX() - referencePoint.getX();
		int p1vy = p1.getY() - referencePoint.getX();
		// p2 vector
		int p2vx = p2.getX() - referencePoint.getX();
		int p2vy = p2.getY() - referencePoint.getX();
		// cross product
		int cross = (p1vx * p2vy) - (p2vx * p1vy);
